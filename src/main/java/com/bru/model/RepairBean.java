...
public class RepairBean {
	...
	public void setRepairEmail(String repairEmail) {
		this.repairEmail = repairEmail;
	}
	public String getRepairWarranty() {
		return repairWarranty;
	}
	public void setRepairWarranty(String repairWarranty) {
		this.repairWarranty = repairWarranty;
	}
	public String getRepairSerialnumber() {
		return repairSerialnumber;
	}
	public void setRepairSerialnumber(String repairSerialnumber) {
	...
	public String getRepairWaste() {
		return repairWaste;
	}
	public void setRepairWaste(String repairWaste) {
		this.repairWaste = repairWaste;
	}

...
public class RepairDao {
	...
	public void insert(RepairBean bean) throws Exception {
		...
		try {
			sql.append(
					" INSERT INTO repair (repair_date, repair_name, repair_address, repair_phone, repair_email, repair_warranty, repair_serialnumber, repair_type, repair_product, repair_waste, repair_detail, repair_appointment) VALUES (?,?,?,?,?,?,?,?,?,?,?,?) ");
			prepared = con.openConnect().prepareStatement(sql.toString());
